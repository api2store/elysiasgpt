...
UI_LOGO = os.environ.get("UI_LOGO") or "https://github.com/audioreworkvisions/elysiasgpt/blob/main/static/assets/33.svg"
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO") or "https://github.com/audioreworkvisions/elysiasgpt/blob/main/static/assets/33.svg"
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Enter manifestations to solve"
UI_CHAT_DESCRIPTION = (
    os.environ.get("UI_CHAT_DESCRIPTION")
    or "Elysias-AI can help solve Taxes and Lawsuite Cases as your AI Assistent GPT."
)
